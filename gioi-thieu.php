...
<link rel="stylesheet" type="text/css" href="css/vechungtoi.css" />
...
<img src="images/logo.gif" width="980" height="132">
  ...
  <div class="boxleft">
 <h1 style="text-align:center"> Xin kính chào quý khách</h1>
<h1>Công Ty TNHH RC chúng tôi là nhà cung cấp các loại ống pô xe máy đủ loại cho các dòng xe máy. Và Chúng tôi đang cố gắng để hoàn thiện trong lĩnh vực phân phối ống pô xe máy, nhằm tối đa sự lựa chọn sản phẩm của quý khách hàng. Chúng tôi cung cấp các loại Pô xe máy: ống pô thường, ống pô kiểu của các hãng như Honda, Yamaha, Suzuki...Và đang cố gắng là nhà cung cấp về lĩnh vực pô xe máy thật chuyên nghiệp nhất có thể.</h1>
</div>
