...
<title>Liên hệ - Ống pô, Ống pô xe máy, Ống pô cho exciter</title>
...
<img src="images/logo.gif" width="980" height="132">
  ...
  <div class="boxleft">
 <h1> Công ty THHH RC</h1> 
   <h2>Địa chỉ: 110 Phan Thanh, Q.Thanh Khê, Đà Nẵng</h2>
   <h2>Email: poxemay@gmail.com</h2>
   <h2>SĐT: 0935 275 447</h2> 
   <h2>Công ty TNHH RC xin cảm ơn quý khách hàng đã ủng hộ các sản phẩm ống pô xe máy trong thời gian qua.</h2>  
   <h2>Quý khách ở xa có thể liên hệ với bộ phận kinh doanh của chúng tôi để mua hàng thông qua các bước đơn giản sau. </h2>
    <div class="form">
		<label> Họ Tên:</label>
		<input class="chung" type="ID" name="ID">
		</div>
        <div class="form">
		<label> Email:</label>
		<input class="chung" type="ID" name="ID">
		...
		<textarea class="diachi" type="address" name="ADR"> </textarea>
		</div>
        <input style="background-color:#0594d2; width:80px; color:#EEE; float:left; margin-left:386px;" type="submit" value="Gửi" />
        <input style="background-color:#0594d2; width:80px; color:#EEE; float:left;" type="submit" value="Nhập lại" />
          </div>   
